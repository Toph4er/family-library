        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <nav aria-label="Book collection navigation" className="flex gap-4">
      ...
      <main id="main-content" className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 animate-fade-in-up">
          <div className="relative">
            <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-text-light/50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        {loading ? (
          <div className="text-center py-16 animate-gentle-pulse" role="status" aria-live="polite">
              ...
              >
                {book.cover_image_url ? (
                  ...
                  <div className="w-full h-32 bg-gradient-to-br from-primary/5 to-secondary/5 flex items-center justify-center">
                    <svg className="w-12 h-12 text-primary/20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                      <path d="M21 5c-1.11-.35-2.33-.5-3.5-.5-1.95 0-4.05.4-5.5 1.5-1.45-1.1-3.55-1.5-5.5-1.5S2.45 4.9 1 6v14.65c0 .25.25.5.5.5.1 0 .15-.05.25-.05C3.1 20.45 5.05 20 6.5 20c1.95 0 4.05.4 5.5 1.5 1.35-.85 3.8-1.5 5.5-1.5 1.65 0 3.35.3 4.75 1.05.1.05.15.05.25.05.25 0 .5-.25.5-.5V6c-.6-.45-1.25-.75-2-1zm0 13.5c-1.1-.35-2.3-.5-3.5-.5-1.7 0-4.15.65-5.5 1.5V8c1.35-.85 3.8-1.5 5.5-1.5 1.2 0 2.4.15 3.5.5v11.5z" />
                    </svg>
                  </div>
                )}
                <div className="p-5">
                  ...
                  {book.child_rating != null && book.child_rating > 0 && (
                    <div className="flex gap-0.5 mt-2" aria-label={`Rating: ${book.child_rating} out of 5 stars`}>
                      {[1, 2, 3, 4, 5].map((star) => (
