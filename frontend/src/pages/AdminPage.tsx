    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="animate-fade-in-up">
          ...
          {/* Error toast */}
          {error && (
            <div className="mb-4 px-4 py-3 bg-error/10 border border-error/20 rounded-xl text-error text-sm animate-fade-in">
              {error}
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="p-1.5 rounded-lg text-text-light/50 hover:text-primary hover:bg-primary/10 transition-colors"
                              title="Edit user"
                            >
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg text-text-light/50 hover:text-error hover:bg-error/10 transition-colors"
                              title="Delete user"
                            >
                              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        <div className="text-center">
          <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-error/10 flex items-center justify-center">
            <svg className="w-7 h-7 text-error" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <polyline points="3 6 5 6 21 6" />
              <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />
